...
const navigationItems = [
  ...
  { title: "Dokumente", url: "/documents", icon: FileText },
  {
    ...
    subItems: [
      ...
      { title: "Nachtragsvereinbarung", url: "/formulare/nachtragsvereinbarung" },
      { title: "Untermieterlaubnis", url: "/formulare/untermieterlaubnis" },
      { title: "Hausordnung", url: "/formulare/hausordnung" },
      { title: "Mieterselbstauskunft", url: "/formulare/mieterselbstauskunft" },
  ...
  { title: "Bewertung", url: "/bewertung", icon: TrendingDown },
  {
    ...
    subItems: [
      ...
      { title: "Anbietervergleich", url: "/energie/anbietervergleich" },
      { title: "Smart-Alerts", url: "/energie/alarme" },
